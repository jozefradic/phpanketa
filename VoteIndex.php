...
<form method="POST" action="Voting.php">
    ...
    <table align="center">
    <input type="radio" name="radio" value="fallout" style="vertical-align: middle">Fallout 76</p>
    <input type="radio" name="radio" value="doom" style="vertical-align: middle">Doom Eternal</p>
    <input type="radio" name="radio" value="rage" style="vertical-align: middle">Rage 2</p>
    <input type="radio" name="radio" value="legends" style="vertical-align: middle">Elder Scrolls Legends</p>
    <input type="radio" name="radio" value="star" style="vertical-align: middle">Starfield</p>
